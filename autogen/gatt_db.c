...
{
  0x4c, 0xcb, 0x96, 0xbe, 0xa8, 0xfb, 0xf8, 0xb1, 0xa9, 0x49, 0x35, 0x58, 0x77, 0xf7, 0x8f, 0x82, 
  0x1f, 0xda, 0x9d, 0x38, 0x49, 0x04, 0xa9, 0xa6, 0x02, 0x4c, 0xf1, 0xb6, 0xec, 0x30, 0xb8, 0x7d, 
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_25) = {
  .len = 16,
  .data = { 0x53, 0x6f, 0x69, 0x6c, 0x48, 0x75, 0x6d, 0x54, 0x72, 0x69, 0x67, 0x4c, 0x65, 0x76, 0x65, 0x6c, }
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_22) = {
  .len = 11,
  .data = { 0x53, 0x6f, 0x69, 0x6c, 0x48, 0x75, 0x6d, 0x44, 0x61, 0x74, 0x61, }
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_18) = {
  .len = 16,
  .data = { 0x38, 0x5e, 0x44, 0xb1, 0xb3, 0xa8, 0x1c, 0x84, 0x70, 0x44, 0x62, 0xd8, 0x08, 0xe3, 0xfb, 0x9d, }
};
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_10) = {
  .properties = 0x0a,
  .max_len = 13,
  .data = { 0x4d, 0x6f, 0x69, 0x73, 0x74, 0x53, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x00, 0x00, },
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x19, .uuid = 0x8001, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_24 },
